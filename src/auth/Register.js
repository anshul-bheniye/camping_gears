...
export const Register = () => {
    ...
    return (
<form onSubmit={handleSubmit} className="my-40 w-full max-w-2xl p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 mx-auto">
    ...
    <button className="text-white bg-green-700 hover:bg-green-800 rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 ">Register</button>
</form>
